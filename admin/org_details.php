...
$count =1;
$sql = $admin->runQuery("SELECT * FROM `pro_democracy` where `status`='Active' ORDER BY `pro_id` DESC");
$sql->execute();
                                ...
                                <div class="widget-body">
                                    ...
                                    <?php foreach ($row as $row) { ?>
                                        <tr class="record">
											...
											<td>
											 <a href="javascript:void(0);"  class="btn btn-sm btn-warning shiny hides" id="<?php echo $row['pro_id'];?>"><i class="fa fa-warning right"></i>Hide</a>
