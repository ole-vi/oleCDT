...
<section id="contact" class=" background-uplod-2" style="padding: 112px 0 5%;">
  <form method="post" action="">
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <div class="col-sm-3">
            <h1 class="lok-lo" ><span style="color:#fff; font-size:55px; font-family:futura-lt-w01-book, sans-serif; letter-spacing:0.15em; text-aline:center;"><b>Collections Development Tool</b></span></h1>
          </div>
                ...
                <form method="post">
                  <div class="mayt-po-pop">
                    <div class="btn-group koi-po">
                      <label class="btn btn-success  mao-po" style="background-color:#fff !important;">
                        <input type="checkbox" name="strategie[]" value="Get Money out of Politics"
                  ...
                  <div class="mayt-po-pop poiop">
                    <div class="btn-group koi-po">
                      <label class="btn btn-success  mao-po" style="background-color:#fff !important; ">
                        <input type="checkbox" name="strategie[]" value="Guarantee Voting Rights"
                  ...
                  <div class="mayt-po-pop poiop op-mi">
                    <div class="btn-group koi-po"  >
                      <label class="btn btn-success  mao-po" style="background-color:#fff !important; ">
                        <input type="checkbox" value="Advocate and Educate" name="strategie[]"
                  ...
                  <div class="mayt-po-pop poiop op-mi po-2-po">
                    <div class="btn-group koi-po">
                      <label class="btn btn-success  mao-po" style="background-color:#fff !important; ">
                        <input type="checkbox" name="strategie[]" value="Dig into Data"
                  ...
                  <div class="mayt-po-pop poiop op-mi po-3-po">
                    <div class="btn-group koi-po">
                      <label class="btn btn-success  mao-po" style="background-color:#fff !important; ">
                        <input type="checkbox" name="strategie[]" value="Take Legal Action"
                  ...
                  <div class="mayt-po-pop poiop op-mi po-4-po">
                    <div class="btn-group koi-po" >
                      <label class="btn btn-success  mao-po" style="background-color:#fff !important; ">
                        <input type="checkbox" name="strategie[]" value="Activate Citizens"
                  ...
                  <div class="mayt-po-pop poiop op-mi po-5-po">
                    <div class="btn-group koi-po">
                      <label class="btn btn-success  mao-po" style="background-color:#fff !important; ">
                        <input type="checkbox" value="Fund the Movement" name="strategie[]"
                  ...
                  <div class="mayt-po-pop poiop op-mi po-6-po">
                    <div class="btn-group koi-po">
                      <label class="btn btn-success  mao-po" style="background-color:#fff !important; ">
                        <input type="checkbox" name="strategie[]" value="Political Action Committee"
                  ...
                  <div class="mayt-po-pop poiop op-mi po-8-po">
                    <div class="btn-group  koi-po  fool ">
                      <label class="btn btn-success  mao-po" style="background-color:#fff !important; ">
                        <input type="checkbox" name="volunteers" value="volunteers"
...
<section  class=" full-mart-div" style="padding: 17px 0 5%;">
  <div class="container">
    <div class="row">
      <div class="col-sm-12 fgh">
        <div class="ads">
          <ul>
            <li> <button class="button button2 " style="height: 29px;">Select <i class="fa fa-arrow-right" aria-hidden="true"></i>
            </button></li>
            <li class="select5" rel="A"><a href="#"> A</a> </li>
            <li class="select5" rel="B"><a href="#"> B </a></li>
            <li class="select5" rel="C"><a href="#"> C </a></li>
            <li class="select5" rel="D"><a href="#"> D </a></li>
            <li class="select5" rel="E"><a href="#"> E</a> </li>
            <li class="select5" rel="F"><a href="#"> F</a> </li>
            <li class="select5" rel="G"><a href="#"> G </a></li>
            <li class="select5" rel="H"><a href="#"> H </a></li>
            <li class="select5" rel="I"><a href="#"> I </li>
            <li class="select5" rel="J"><a href="#"> J </a></li>
            <li class="select5" rel="K"><a href="#"> K </a></li>
            <li class="select5" rel="L"><a href="#"> L </a></li>
            <li class="select5" rel="M"><a href="#"> M </a></li>
            <li class="select5" rel="N"><a href="#"> N </a></li>
            <li class="select5" rel="O"><a href="#"> O </a></li>
            <li class="select5" rel="P"><a href="#"> P </a></li>
            <li class="select5" rel="Q"><a href="#"> Q </a></li>
            <li class="select5" rel="R"><a href="#"> R </a></li>
            <li class="select5" rel="S"><a href="#"> S </a></li>
            <li class="select5" rel="T"><a href="#"> T </a></li>
            <li class="select5" rel="U"><a href="#"> U </a></li>
            <li class="select5" rel="V"><a href="#"> V </a></li>
            <li class="select5" rel="W"><a href="#"> W </a></li>
            <li class="select5" rel="X"><a href="#"> X </a></li>
            <li class="select5" rel="Y"><a href="#"> Y</a> </li>
            <li class="select5" rel="Z"><a href="#"> Z </a></li>
          </ul>
        </div>
      </div>
      <div id="masterdiv">
