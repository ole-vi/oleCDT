...
<input type="search" placeholder="Type Your Search Here" name="googlesearch">
</div>
 ...
 <div class="col-sm-3 padin">
  ...
  <a href="login-page.html"> <button type="button" class="default btn-lg bun-1" >Login <i class="fa fa-user" aria-hidden="true"></i></button></a>
