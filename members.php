...
if(isset($_POST['submit']))
{
  ...
  {
    $sql1 = "SELECT * from `tbl_individual_member` where `state` IS NOT NULL";
  }
  else if(($state=='') and ($volunteers!=''))
  {
    $sql1 = "SELECT * from `tbl_individual_member` where `seeking` IS NOT NULL";
  }
  else
  {
    $sql1 = "SELECT * from `tbl_individual_member` where (`state` and `seeking`) IS NOT NULL";
  }
        ...
        <div class="col-sm-12">
          <div class="col-sm-3">
            ...
            <div class="sdfr ">
              ...
              <button class="button button2 " style='background-color: hsl(113, 82%, 51%) !important;color: hsl(222, 100%, 34%) !important;'>Members</button>
            </div>
          </div>
            ...
            <div class="lo-imh">
              ...
              <div class="io-poli" style="margin-top:-45px;">
                <form method="post">
                  ...
                  <div class="box-po">
                    <div class="btn-group <?php echo 'koi-po-'.$strategy_class[$k];?>">
            ...
            <a href="detailpage?id=<?php echo base64_encode($row['pro_id']);?>">
              <div class="col-sm-12 no-background" >
                ...
                <div class="col-sm-9">
                  <?php foreach($strategy_list as $k => $sl) { ?>
                    <div class="box-po">
                        <div class="btn-group <?php echo 'koi-po-'.$strategy_class[$k] ?>" data-toggle="buttons">
