<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8"><link type="text/css" rel="stylesheet" href="<?php echo $site_url;?>css/css_002.css">
...
if(searchid!='')
{
	$.ajax({
	type: "POST",
	url: "<?php echo $site_url;?>main_search.php",
	data: dataString,
	cache: false,
...
<!-- <a href="<?php echo $site_url;?>editprofile.php?id=<?php echo base64_encode($_SESSION['id']); ?>"> <button type="button" class="default btn-lg bun-1" >edit Myaccount<i class="fa fa-user" aria-hidden="true"></i></button></a>-->
   <a href="<?php echo $site_url;?>admin/myaccount.php"> <button type="button" class="default btn-lg bun-1" >Myaccount<i class="fa fa-user" aria-hidden="true"></i></button></a>
	          ...
	          <div class="row">
	            <div class="col-sm-3">
	              ...
	              <div class="navbar-header">
	                ...
	                <h1 class="nav-logo"><a class="nav-brand" href="index.html"> <img class="mat"src="<?php echo $site_url;?>img/logo-white.png" ></a></h1>
	              </div>
	            </div>
